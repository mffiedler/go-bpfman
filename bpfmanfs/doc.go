// Package bpfmanfs models bpfman's runtime filesystem hierarchy and
...
//     programmer errors.
//   - [FilesystemContext]: proves that directories exist and bpffs is
//     mounted. Obtained from bpfmanfs/runtime.New() and required by
//     manager.New().
...
// # Filesystem Domains
//
// [FSLayout] provides access to two domain types:
//
...
//   - [BytecodeFS]: regular-filesystem operations for bytecode
...
// /var/cache/bpfman), which is separate from [FSLayout] because they
// have different lifecycles: FSLayout points at tmpfs cleared on
