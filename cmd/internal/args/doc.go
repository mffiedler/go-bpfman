...
// here -- ProgramID, LinkID, KeyValue, GlobalData, ObjectPath,
// ImagePullPolicy -- whose parser, called by Kong at bind time, returns
...
// to check.
//
// The map helpers (MetadataMap, GlobalDataMap) and slice parsers
// (ParseProgramTypes, ParseLinkKindsSlice, and the rest) fold the
// parsed values into the shapes the manager API expects.
package args
